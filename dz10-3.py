...
class Cell:
    ...
    def __sub__(self, other):
        ...
        return Cell(self.nums - other.nums) if self.nums - other.nums > 0 else 'Ячеек в первой клетке меньше, чем во второй, вычитание fail'
...
cell_1 = Cell(75)
cell_2 = Cell(17)
print('Первая клетка из', cell_1, 'ячеек')
print('Вторая клетка из', cell_2, 'ячеек')
print(cell_1 + cell_2)
print(cell_1 - cell_2)
print(cell_1 * cell_2)
print(cell_1 // cell_2)
